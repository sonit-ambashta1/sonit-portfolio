...
export default function Education() {
  return (
    <Section
      id="education"
      title="Education"
      subtitle="B.S. in Computer Science and Applied Mathematics (Expected May 2028) at The College of New Jersey"
    >
      <div className="relative overflow-hidden rounded-xl border border-glass-border bg-glass-bg p-8 shadow-primary backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {educationData.map((course, index) => (
            <div
              key={index}
              className="rounded-lg border border-glass-border bg-[rgba(16,19,31,0.5)] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:bg-[rgba(26,30,46,0.7)] hover:shadow-secondary"
            >
